...
output "application_insights_application_type" {
  ...
  value       = module.application_insights.application_insights_application_type
}
...
output "application_insights_force_customer_storage_for_profiler" {
  ...
  value       = module.application_insights.application_insights_force_customer_storage_for_profiler
}
...
output "application_insights_internet_ingestion_enabled" {
  ...
  value       = module.application_insights.application_insights_internet_ingestion_enabled
}
...
output "application_insights_internet_query_enabled" {
  ...
  value       = module.application_insights.application_insights_internet_query_enabled
}
...
output "application_insights_local_authentication_enabled" {
  ...
  value       = module.application_insights.application_insights_local_authentication_enabled
}
...
output "application_insights_location" {
  ...
  value       = module.application_insights.application_insights_location
}
...
output "application_insights_resource_group_name" {
  ...
  value       = module.application_insights.application_insights_resource_group_name
}
...
output "application_insights_retention_in_days" {
  ...
  value       = module.application_insights.application_insights_retention_in_days
}
...
output "application_insights_sampling_percentage" {
  ...
  value       = module.application_insights.application_insights_sampling_percentage
}
...
output "application_insights_tags" {
  ...
  value       = module.application_insights.application_insights_tags
}
...
output "application_insights_workspace_id" {
  ...
  value       = module.application_insights.application_insights_workspace_id
}
